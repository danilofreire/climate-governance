...
\begin{footnotesize}
\begin{longtable}{l|l}
\caption{\textbf{Design principles for climate change mitigation conjoint experiments}} \label{tab:categories} \\

\hline \multicolumn{1}{c|}{\textbf{Attribute}} & \multicolumn{1}{c}{\textbf{Values}}\\ \hline 
\endfirsthead 

\multicolumn{2}{c}%
{{\tablename \: \thetable{}: \textbf{Design principles for climate change mitigation conjoint experiments} (\textit{cont.})}} \\
\hline \multicolumn{1}{c|}{\textbf{Attribute}} & \multicolumn{1}{c}{\textbf{Values}} \\ \hline 
\endhead
...
% Add paragraph about marginal means -- cite Leeper (2019).
