---
title: "Appendix: Latin American Elites Favour Polycentric Governance in Climate Change Agreements"
output: pdf_document
toc: true
...
header-includes:
    ...
    - \usepackage{hyperref}
    - \hypersetup{linkcolor=Mahogany, citecolor=Mahogany, urlcolor=darkblue, breaklinks=true}
    - \usepackage{multirow}
    - \usepackage{wrapfig}
    - \usepackage{float}
    - \usepackage{colortbl}
